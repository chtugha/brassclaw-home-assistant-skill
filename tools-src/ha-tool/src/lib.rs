...
fn execute_inner(params: &str) -> Result<String, String> {
    ...
    match action {
        ...
        HaAction::ActivateScene { ha_url, entity_id } => api::activate_scene(&ha_url, &entity_id),
        HaAction::MqttPublish {
            ha_url,
            topic,
            payload,
            qos,
