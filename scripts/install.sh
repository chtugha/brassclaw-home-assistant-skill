...
if [[ "$HA_URL" =~ ^http:// ]] || [[ "$HA_URL" =~ \.(local|lan|home|internal)(:|/|$) ]] || [[ "$HA_URL" =~ ^https?://(localhost|127\.|192\.168\.|10\.|172\.(1[6-9]|2[0-9]|3[01])\.) ]]; then
    echo "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo "  ${YELLOW}  HTTPS setup recommended for REST access${NC}"
    echo "  ${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo "  The IronClaw sandbox requires HTTPS + public hostname for"
    echo "  ha-tool REST calls. Your current URL (${HA_URL}) will only"
    echo "  work via the native shell tool with curl."
    echo ""
    echo "  To enable full REST access, set up DuckDNS + Let's Encrypt:"
